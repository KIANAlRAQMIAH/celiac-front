...
const Donations = () => {
    ...
    //   ...
    const { data, status, isLoading } = useGetDonationsQuery();
    ...
    const handleEdit = (member: any) => {
        ...
        setDestination(member.destination_name)
        setEditing(true);
        setModalOpen(true);
    };
    ...
    const addMember = () => {
        navigate('/home/donations/donationDetails');
        clearForm();
        setEditing(false);
    };
    ...
    return (
        <div>
            <div className="flex items-center justify-between flex-wrap gap-4">
                <h2 className="text-xl">التبرعات</h2>
                            ...
                            <div className="flex items-center justify-center min-h-screen px-4">
                                ...
                                >
                                    ...
                                    <Dialog.Panel as="div" className=" panel border-0 p-5 rounded-lg overflow-hidden w-full max-w-lg my-8 text-black dark:text-white-dark">
                                        <h5 className="font-bold text-lg  text-primary/90 my-[8px]">التعديل</h5>
                                        <div className="p-5">
