...
import { useDeleteStrategicPartnershipsMutation, useGetMembershipsQuery } from '../../api/AboutUsSlice/CommitteesSlice';
import { toast } from 'react-toastify';
import { usePermissions } from '../../utils/permissions';
import AddMembershipModal from './membership-modal';
...
const MemberShips = (props: Props) => {
    ...
    //@ts-ignore
    const { data, isSuccess, refetch } = useGetMembershipsQuery(page);
    ...
    return (
        <div>
            <AddMembershipModal open={open} setOpen={setOpen} selectedMaterial={selectedMaterial} />
                ...
                <div className="panel">
                    ...
                    <div className="datatables mt-5">
                                    ...
                                    <tr key={record.id}>
                                        ...
                                        <td>
                                            <ul className='flex items-center gap-1'>
                                                {record.names.map((benefit: any, index: number) => (
                        ...
                        <div className="flex justify-between items-center mt-4">
                            <div>
                                <span>{`عرض ${Math.min((page - 1) * pageSize + 1, totalRecords)} إلى ${Math.min(page * pageSize, totalRecords)} من ${totalRecords} مدخلات`}</span>
                            </div>
