...
import SessionsForm from './TrainingForm';
import { useGetRecordsQuery } from '../../../api/serveces';
import useDeleteConfirmation from '../../../hooks/useDeleteConfirmation';
import EventsForm from './TrainingForm';
import EventsDetails from './TrainingCourseDetails';
import CookingCourseForm from './TrainingForm';
import TrainingCourseDetails from './TrainingCourseDetails';
import TrainingCourseForm from './TrainingForm';
...
export default function TrainingCourses() {
    ...
    const deleteSubmitHandler = useDeleteConfirmation({ url: 'training-courses', inValid: 'training-courses' });
        ...
        <Main_list title="برامج الطهي">
            ...
            {open && editData?.id && !viewId && (
                <CustomModal openCloseModal={setOpen} title={`عرض تفاصيل برنامج الطهي`} resetEditData={setEditData}>
                    <TrainingCourseForm editData={editData} resetEditData={setEditData} openCloseModal={setOpen} />
                </CustomModal>
            )}
            {open && viewId && !editData?.id && (
                <CustomModal openCloseModal={setOpen} title={`عرض تفاصيل برنامج الطهي`} setViewId={setViewId}>
                    {/* @ts-ignore */}
                    <TrainingCourseDetails viewId={viewId}   openCloseModal={setOpen} setEditData={setEditData} />
                </CustomModal>
            )}
