    ...
    <div className="w-full mx-auto p-6 bg-white shadow-lg border border-gray-200">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div>
          ...
          <p className="text-base text-gray-700">{data?.data.session_date ?? "غير متوفر"}</p>
        </div>
        <div>
        ...
        <div>
          ...
          <p className="text-base text-gray-700">{data?.data.event_type_text}</p>
        </div>
        <div>
