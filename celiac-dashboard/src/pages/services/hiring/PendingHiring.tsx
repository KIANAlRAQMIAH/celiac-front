...
// import { useAcceptJobReqMutation, useGetPendingJopsQuery, useRejecttJobReqMutation } from '../../../api/serveces';
...
//     const { data, isLoading, isSuccess } = useGetPendingJopsQuery()

//     const [acceptJobReq] = useAcceptJobReqMutation()
//     const [rejecttJobReq] = useRejecttJobReqMutation()
...
//         }).then(async (willDelete: any) => {
//             if (willDelete) {
//                 const mutation = status === "2" ? acceptJobReq : rejecttJobReq;
