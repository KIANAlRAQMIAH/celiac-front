...
function GlutenSensitivityComponent({ GlutenSensitivityData }: any) {
    // State hooks
    ...
    useEffect(() => {
        if (GlutenSensitivityData) {
            setfileList(GlutenSensitivityData);
        }
                                            ...
                                            <div className='flex flex-col '>
                                                <div className='flex  justify-around items-center text-center'>
                                                    <div className='flex items-center justify-center '>
                                                        <label htmlFor="general" className='mx-2 mt-1 peer-checked:text-primary'>عام</label>
                                                        <input
                                                            type="radio"
                                                            id="general"
                                                            name="fileType"
                                                    ...
                                                    <div className='  flex items-center justify-center'>
                                                        <label htmlFor="gluten" className='mx-2 mt-1 peer-checked:text-primary'>حساسية الغلوتين</label>
                                                        <input
                                                            type="radio"
                                                            id="gluten"
                                                            className="cursor-pointer form-radio text-primary peer"
...
export default GlutenSensitivityComponent;
