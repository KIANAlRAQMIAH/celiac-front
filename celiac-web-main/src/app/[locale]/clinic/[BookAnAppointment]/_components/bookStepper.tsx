        ...
        <Stepper.Step label="اختر التخصص" description="">
          <div className=" flex flex-col gap-[32px]">
            <div className="flex flex-col gap-[4px]">
              ...
              يرجى اختيار التخصص الطبي الذي ترغب في الحجز لديه من بين التخصصات المتاحة، وذلك لتمكيننا من عرض المواعيد المتوفرة التي يمكنك الاختيار من بينها بما يتناسب مع احتياجك.              </p>
            </div>
            {clinicIsLoading ? (
        ...
        <Stepper.Step label="اختر الوقت المناسب" description="">
          <div className=" flex flex-col gap-[32px]">
            <div className="flex flex-col gap-[4px]">
              ...
              <p className="text-[#869791] text-[16px] font-[400]">
              يرجى تحديد اليوم المناسب، ثم اختيار الوقت الأنسب لك من بين المواعيد المتاحة
              </p>
