        ...
        <div className=" container mx-auto">
          ...
          <div className="grid md:grid-cols-2 grid-cols-1 gap-4 justify-between items-center mb-[10px]">
            <div className="">
              ...
              <div className="text-[#45534E] text-[16px] font-[500]">بطاقة تصدر بإشراف جمعية السلياك ، وتمنح مرضى السلياك خصومات خاصة لدى مجموعة من المتاجر المعتمدة التي توفّر منتجات غذائية خالية من الجلوتين، بالإضافة إلى مستشفيات ومختبرات طبية معتمدة تقدم خدمات تشخيص ومتابعة للحالات وفق أعلى المعايير.
              .تهدف البطاقة إلى تسهيل حصول المرضى على احتياجاتهم الغذائية والطبية، والمساهمة في تخفيف الأعباء المالية، ودعمهم نحو أسلوب حياة صحي وآمن</div>
            </div>
