...
import pdfIcon from '../../../../../../public/apple.png'
import Link from "next/link";
const LibraryPdfComponent = (props: {
    title: string,
    size?: string,
    date?: string,
    disc?: string,
    ...
    return (
        <a href={props?.url} target="_blank">
            <div className="bg-[transparent] transition-all hover:bg-[#FFF] border flex w-[100%] md:flex-row flex-col  justify-start items-center md:px-[24px] px-[22px] md:py-[24px] py-[22px] rounded-[10px] gap-[14px] text-right">
...
export default LibraryPdfComponent;