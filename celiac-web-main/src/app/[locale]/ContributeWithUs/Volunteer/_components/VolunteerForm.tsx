...
import { Button, Paper, Radio, Select, TextInput } from "@mantine/core";
...
import { z } from "zod";
import { useCreateVolunteerRequestMutation } from "@/api/serveces";
...
const VolunteershipForm = () => {
    ...
    const [createVolunteerRequest, { isLoading }] = useCreateVolunteerRequestMutation()
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        const data = await createVolunteerRequest(formData);
        console.log(data);
        // @ts-ignore
